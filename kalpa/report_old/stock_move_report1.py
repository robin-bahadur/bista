...
class move_old(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context=None):
        super(move_old, self).__init__(cr, uid, name, context=context)
...
report_sxw.report_sxw('report.stock.location1', 'stock.location', 'addons/kalpa/report/stock_picking_move1.rml', parser=move_old)
