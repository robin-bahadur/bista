...
class stock_export_csv(osv.osv_memory):
    ...
    def export_csv(self, cr, uid, ids, context=None):
        ...
        datas.append(None)
        datas.append(None)
        datas.append(location_obj.address_id.name)
        pls_write = writer.writerow(datas)
        datas = []
        ...
        datas.append(None)
        datas.append(None)
        x = location_obj.address_id.street2
        street2 = str(x)
        street = location_obj.address_id.street
        datas.append(street + " " +  street2)
        pls_write = writer.writerow(datas)
        datas = []
        ...
        datas.append(None)
        datas.append(None)
        str_data = location_obj.address_id.zip + " " + location_obj.address_id.city
        ...
        return self.write(cr, uid, ids, {'state':'get', 'csv_file':out,'name': string})
