...
class product_internal_transfer(osv.osv_memory):
    ...
    def imp_file(self, cr, uid, ids,context):
        """ function to import Products for internal moves csv file  """
                ...
                if len(row):
                    ...
                    while row_count >= 0:
                        ...
                        if row_count==0 and value and col >= 1:
                            ...
                            src_location_id = location_obj.search(cr,uid,[('name', '=',source_location)])
                        ...
                        if row_count==1 and value and col >= 1:
                            ...
                            dest_location_id = location_obj.search(cr,uid,[('name', '=',destination_location)])
